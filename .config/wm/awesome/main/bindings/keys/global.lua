...
awful.keyboard.append_global_keybindings({
  ...
  end, { description = "open windows menu", group = "launcher" }),
...
awful.keyboard.append_global_keybindings({
  awful.key({ modkey }, "s", function()
    ...
    hotkeys_popup.widget
      .new({
        width = 1200,
        height = 750,
        font = "Ubuntu Nerd Font 14",
        description_font = "Ubuntu Nerd Font 14",
      })
  ...
  awful.key({ modkey, "Shift" }, "q", function()
    awful.spawn("bash .config/awesome/scripts/powermenu.sh", false)
  ...
  end, { description = "open navigator", group = "launcher" }),
  awful.key({ modkey }, "t", function()
    awful.spawn(files, false)
  end, { description = "open file explorer", group = "launcher" }),
  awful.key({ modkey }, "r", function()
    awful.spawn(rofi, false)
  end, { description = "open application menu", group = "launcher" }),
})
