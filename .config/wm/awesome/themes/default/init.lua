...
theme.font_size = dpi(17)

theme.icon_font_name = "UbuntuNerdFont"
theme.icon_font_size = dpi(17)
...
theme.taglist_font = "UbuntuNerdFont 17"
theme.notification_font = "UbuntuNerdFont 17"
...
theme.wallpaper = "~/.config/awesome/themes/wallpapers/l2GXHw0.png"
